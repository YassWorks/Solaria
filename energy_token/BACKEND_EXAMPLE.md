        ...
        for (let i = 1; i < nextId; i++) {
            ...
            if (balance > 0) {
                ...
                portfolio.push({
                    ...
                    currentSharePrice: ethers.formatEther(
                        project.pricePerShare
                    ),
                    estimatedValue: ethers.formatEther(
...
router.get("/:address/projects/:projectId", async (req, res) => {
    try {
        ...
        const balance = await blockchain.contract.balanceOf(
            userAddress,
            projectId
        );
        ...
        res.json({
            ...
            data: {
                ...
                estimatedAnnualKwh: Number(position.estimatedAnnualKwh),
                averageReturnRate:
                    (Number(position.lifetimeKwh) /
                        Number(position.estimatedAnnualKwh)) *
                    100,
